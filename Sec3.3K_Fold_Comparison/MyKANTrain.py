...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str,
                        default="/media/aiofm/F/20250723_k-fold-cross-validation-KAN/8-fold",
                        help='HDF5数据集根目录')
    ...
    parser.add_argument('--SaveTrainLossPath', type=str,
                        default="/home/aiofm/PycharmProjects/MyKANNet/15e-16_Kan4LayerParam_L1Regu/record_train_loss_8_fold-524-524-524_15_2.txt")
    parser.add_argument('--SaveValLossPath', type=str,
                        default="/home/aiofm/PycharmProjects/MyKANNet/15e-16_Kan4LayerParam_L1Regu/record_val_loss_8_fold-524-524-524_15_2.txt")
    parser.add_argument('--SavePara', type=str,
                        default="/home/aiofm/PycharmProjects/MyKANNet/15e-16_Kan4LayerParam_L1Regu/Kan_Para_8_fold-524-524-524_15_2.pt")
    parser.add_argument('--SaveLastPara', type=str,
                        default="/home/aiofm/PycharmProjects/MyKANNet/15e-16_Kan4LayerParam_L1Regu/Last_Kan_Para_8_fold-524-524-524_15_2.pt")
